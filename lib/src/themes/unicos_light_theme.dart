...
class UnicosLightTheme {
  static final theme = ThemeData(
    primarySwatch: const MaterialColor(0xFF28C76F, {
    ...
    extensions: [UnicosNavBarTheme(), UnicosTextFiledTheme()],
    textTheme: TextTheme(
      bodyMedium: TextStyle(fontSize: 14, color: UnicosColor.darkBody),
    ),
  );
}
